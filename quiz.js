...
async function quiz() {
    ...
    const question3 = await inquirer.prompt({
        message: chalk.green("Which keyword is used to define a type alias in TypeScript?"),
        name: "q3",
        type: "list",
    ...
    const question4 = await inquirer.prompt({
        message: chalk.green("Which TypeScript feature allows you to combine multiple types together?"),
        name: "q4",
        type: "list",
        choices: [
            "1- Type union (|)",
    ...
    const question5 = await inquirer.prompt({
        message: chalk.green("what will be the output  \n lett message : string = 'hello everyone'; \n console.log(message);?"),
        name: "q5",
        type: "list",
        choices: [
            "1- hello everyone",
